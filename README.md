...
1) `Управление настройками` - содержит команды для экспорта, импорта и очистки настроек. Cм. подробнее в разделе ["Экспорт, импорт и очистка настроек"](#Экспорт_импорт_и_очистка_настроек_1).
...
<a id="Экспорт_импорт_и_очистка_настроек_1"></a>
