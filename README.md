...
> Описание доступно в документации по БСП в разделах [Программный интерфейс](https://its.1c.ru/db/bsp321doc#content:984:hdoc) и [Пользовательская документация](https://its.1c.ru/db/bsp321doc#content:984:hdoc)
