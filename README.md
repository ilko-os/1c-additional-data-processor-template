...
3) Добавление настроек и задание их значений в режиме "1С:Предприятие"
	* Плюсы:
		...
		- Скорость
	* Минусы
		- Возможны, опечатки в именах настроек, т.к. они независмо добавляются в режиме "1С:Предприятие" и затем извлекаются при написании кода в режиме "1С:Конфигуратор"
