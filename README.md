...
1) Описание настроек в "1С:Конфигуратор" + Задание значение настроек в режиме "1С:Предприятие"
	* Плюсы:
		- Упрощают написание кода с последующим доступам к значениям  настроек в режиме "1С:Конфигуратор"
	* Минусы
		- Скорость
  		- Требуется писать код
3) Описание настроек и задание их значений в режиме "1С:Предприятие"
	* Плюсы:
		- Простота
		- Скорость
	* Минусы
...
Описание настроек в "1С:Конфигуратор" производится через 4 процедуры:
