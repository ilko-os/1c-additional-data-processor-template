...
#Область ЗагрузитьНастройкиПоУмолчанию


// Имя - Имя параметра, задается по правилам именования переменных, в дальнешем исполюзутся, как ключ в структуре для доступа к значению параметра.
// ТипКонтейнера - Число(1, 0) - Описывает структуру для хранения параметра, доступны следующие варианты
// 0 - Нет,
// 1 - СписокЗначений
// 2 - Массив
// 3 - ТаблицаЗначений
// ТипЗначения - ОписаниеТипов - Описывает допустимые типы для параметра
// Значение - Произвольный - хранит значение(я) параметра в соответствии с определенными "ТипКонтейнера" и "ТипЗначения"
...
// 
// Параметры:
//  НастройкиКомандыБезопасноеХранилище - ТаблицаЗначений - соответствует одноименному реквзиту на форме
//  ИдентификаторКоманды - Строка - Идентификатор команды определенный в функции "СведенияОВнешнейОбработке()"
//  РежимЗагрузкиНастроекПоУмолчанию - Строка - Определяет режим добавления строк: "Обновление", "ДобавлениеНовых", "Замещение" 
