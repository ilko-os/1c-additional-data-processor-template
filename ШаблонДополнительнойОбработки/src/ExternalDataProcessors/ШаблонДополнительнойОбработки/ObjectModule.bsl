...
// ПараметрыКоманды.НастройкиОбработки 	- Структура - содержит параметры с вкладки "Настройки обработки"	 
// ПараметрыКоманды.НастройкиОбработкиБезопасноеХранилище - Структура - содержит параметры с вкладки "Настройки обработки (Безопасное хранилище)"
// ПараметрыКоманды.НастройкиКоманды - Структура - содержит параметры с вкладки "Настройки команды"
// ПараметрыКоманды.НастройкиКомандыБезопасноеХранилище - Структура - содержит параметры с вкладки "Настройки команды (Безопасное хранилище)"
Перем ПараметрыКоманды;

Перем НастройкиОбработки; 							//	Структура - содержит параметры с вкладки "Настройки обработки"
Перем НастройкиОбработкиБезопасноеХранилище; 		//	Структура - содержит параметры с вкладки "Настройки обработки (Безопасное хранилище)"
Перем НастройкиКоманды; 							//	Структура - содержит параметры с вкладки "Настройки команды"
Перем НастройкиКомандыБезопасноеХранилище; 			//	Структура - содержит параметры с вкладки "Настройки команды (Безопасное хранилище)"
...
// НастройкиКомандИОбработки.НастройкиОбработкиБезопасноеХранилище - Структура - содержит параметры с вкладки 
// 		"Настройки обработки (Безопасное хранилище)"
// НастройкиКомандИОбработки[ИдентификаторКоманды].НастройкиКоманды - Структура - содержит параметры с вкладки 
// 		"Настройки команды" для указанного идентификатора команды
// НастройкиКомандИОбработки[ИдентификаторКоманды].НастройкиКомандыБезопасноеХранилище  - Структура - 
// 		содержит параметры с вкладки "Настройки команды (Безопасное хранилище)" для указанного идентификатора команды
...
Функция СведенияОВнешнейОбработке() Экспорт
	...
	ПараметрыРегистрации.Информация = "Шаблон_ДополнительнаяОбработка";  
